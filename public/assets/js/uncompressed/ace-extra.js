...
ace.settings = {
	...
	sidebar_collapsed : function(collpase) {
		...
		if(collpase) {
			...
			$("img.logo").hide(); // temporary fix. need to swap out jQuery to pure JS. More details in Bitbucket Issue #101
			...
			$("img.logo").show(); // temporary fix. need to swap out jQuery to pure JS. More details in Bitbucket Issue #101
