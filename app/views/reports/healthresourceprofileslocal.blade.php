...
@section('report')
	...
	@if(count($facilities))
		<h3>Health Resource Profiles: Local Specialty Services</h3><br>
		{{ View::make('partials.reportFacilityTabular', array( 
			'facilities' => $facilities, 
			'headers' => ['Local Specialty Services:',"".ucfirst($instance->facility_term). " Name:","".ucfirst($instance->facility_term). " Address:","".ucfirst($instance->facility_term). " Type:", 'Contact Person:', 'Title:', 'Telephone:', 'Email:'],
